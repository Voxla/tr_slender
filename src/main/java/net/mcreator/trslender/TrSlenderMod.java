...
import net.mcreator.trslender.init.TrSlenderModTabs;
import net.mcreator.trslender.init.TrSlenderModSounds;
...
public class TrSlenderMod {
	...
	public TrSlenderMod() {
		...
		TrSlenderModSounds.REGISTRY.register(bus);
		...
		TrSlenderModTabs.REGISTRY.register(bus);
