...
public class Staticlowpacrender1Procedure {
		...
		if (new Object() {
			...
			if (entity instanceof LivingEntity _livEnt2 && _livEnt2.hasEffect(TrSlenderModMobEffects.SLENDER_STATIC.get())) {
				if ((entity.getCapability(TrSlenderModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new TrSlenderModVariables.PlayerVariables())).staticnorm > 43
					...
					if ((entity.getCapability(TrSlenderModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new TrSlenderModVariables.PlayerVariables())).staticlowpac == 0) {
						return true;
					}
				}
			}
