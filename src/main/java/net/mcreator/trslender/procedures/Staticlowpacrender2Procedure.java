...
public class Staticlowpacrender2Procedure {
	public static boolean execute(Entity entity) {
		...
		if (new Object() {
			...
			if (entity instanceof LivingEntity _livEnt ? _livEnt.hasEffect(TrSlenderModMobEffects.SLENDER_STATIC.get()) : false) {
				if ((entity.getCapability(TrSlenderModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new TrSlenderModVariables.PlayerVariables())).staticnorm > 43
						&& (entity.getCapability(TrSlenderModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new TrSlenderModVariables.PlayerVariables())).staticnorm < 137
					...
					if ((entity.getCapability(TrSlenderModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new TrSlenderModVariables.PlayerVariables())).staticlowpac == 1) {
						return true;
					}
				}
			}
